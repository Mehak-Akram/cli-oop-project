...
const programStart = async (persons) => {
    do {
        ...
        const ans = await inquirer.prompt({
            name: "select",
            type: "list",
            message: chalk.bold.green(chalk.bold.green("what would you like to interect with?")),
            choices: ["staff", "student", "exit"],
        });
        if (ans.select == "staff") {
            console.log(chalk.bold.blue("you approch staff room.please feel free to ask any question"));
        }
